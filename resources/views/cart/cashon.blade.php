                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                            <small>ORDER</small> #{{ $orders->order_id }}  <br />
                  ...
                  <tbody>
                    ...
                    @foreach ($cartItems as $id => $item)                
                        ...
                        <tr>
                          ...
                          <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;"><small>${{$item['price']}}</small></td>
                          ...
                          <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;" align="right">${{ $item['price'] * $item['quantity'] }}</td>
                        </tr>
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                        <strong>${{ $total=$item['price'] * $item['quantity']+50 }}</strong>
                      </td>
                    </tr>
                      ...
                      <td>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                               {{$info->firstname}}<br>{{$info->aaddress_line_one}}<br>{{$info->country_name}}<br> 4468, United States<br>{{$info->size_code}}
                              </td>
                            </tr>
                        ...
                        <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                          <tbody>
                            ...
                            <tr>
                              <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                               {{$orders->payment_type}}<br>Worldpay Transaction ID: <a href="#" style="color: #ff0000; text-decoration:underline;">4185939336</a><br>
